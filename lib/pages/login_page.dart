...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        // Устанавливает фоновый цвет Scaffold
        body: SafeArea(
            ...
            child: Expanded(
              ...
              child: Center(
                ...
                child: Padding(
                  ...
                  // Устанавливает горизонтальные и вертикальные отступы
                  child: Column(
                    // Виджет, который отображает своих детей в вертикальной последовательности
                    mainAxisAlignment: MainAxisAlignment.center,
                    // Центрует детей в основной оси (вертикальной)
                    children: [
                      ...
                      MyTextField(
                          ...
                          hintText: 'Email',
                          // Текст-подсказка, отображаемый в текстовом поле, когда оно пустое
                          obscureText: false),
                      // Скрывает текст, если true (используется для паролей). Здесь set to false
                      SizedBox(height: 10),
                      // Оставляет пустое пространство с фиксированной высотой
                      // поле для пароля
                      MyTextField(
                          ...
                          // Текст-подсказка
                          obscureText: true),
                      // Текст становится невидимым при вводе, обычно для паролей
                      SizedBox(height: 25),
                      // Оставляет пустое пространство с фиксированной высотой
                      // кнопка входа
                      MyButton(onTap: signIn, text: "Sign In"),
                      // Пользовательский виджет кнопки (не встроенный)
                      ...
                      Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        // Центрирует детей в основной оси (горизонтальной)
                        children: [
                          Text('Not a member?'),
                          // Виджет текста, отображает эту строку
                          SizedBox(width: 4),
                          ...
                          GestureDetector(
                            ...
                            child: Text(
                              'Register Now',
                              // Виджет текста с предложением зарегистрироваться
                              style: TextStyle(
                                  // Стиль текста
                                  fontWeight:
